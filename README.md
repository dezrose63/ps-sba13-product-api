...
#  Per Scholas Software Engineer Bootcamp SBA 13
...
- In **routes/productRoutes.js**, use **express.Router()** to define your API endpoints.
- The logic for each route should be handled directly within the route file for this assessment.
...
- Test all your endpoints thoroughly using an API client like Postman or Insomnia.
- Pay special attention to the advanced query endpoint, testing various combinations of filters, sorting, and pagination.
